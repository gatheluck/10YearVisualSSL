...
DOWNSTREAM_METRICS = {
    ...
    "coco_map_75": COMPARABLE,
    "coco_map_small": COMPARABLE,
    "coco_map_medium": COMPARABLE,
    "coco_map_large": COMPARABLE,
    "nyuv2_rmse": COMPARABLE,
    "nyuv2_absrel": COMPARABLE,
    "nyuv2_delta1": COMPARABLE,
    "nyuv2_delta2": COMPARABLE,
    "nyuv2_delta3": COMPARABLE,
