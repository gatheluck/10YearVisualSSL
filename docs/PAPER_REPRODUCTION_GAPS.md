...
| 2 | Remaining Step-4 continuations and assignment semantics are absent | H1S200 checkpoint split at epoch 200; H1CORE continuation without Gram; H1JA joint assignment/mass logic, then distributed physical-batch and precision parity | Not implemented by the component change; resume explicitly refused |
