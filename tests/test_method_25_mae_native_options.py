...
class TestOptions(unittest.TestCase):
    ...
    def test_options_reach_inference_and_defaults_are_preserved(self):
        ...
        imports = {'adapter': adapter, 'evaluate_linear_mae': evaluator}
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(pools, ['avg', 'cls'])
            self.assertEqual(meta['pool'], 'cls')
...
class TestArtifact(unittest.TestCase):
    def test_exact_native_identity_and_protocol(self):
        ...
        self.assertEqual(r['sha256'], '531e92c6dbe493bceb591792ba147282e88b55ea8667dbe55c981750904921bd')
        self.assertEqual(r['feature_options'], {'pool': 'cls'})
