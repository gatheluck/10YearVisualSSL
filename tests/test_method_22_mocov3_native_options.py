...
class TestOptions(unittest.TestCase):
    def test_provider_rejects_unsupported_options(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            torch.save({}, encoder)
            options = {'interpolation': 'bilinear', 'resize_short_side': 256}
    ...
    def test_options_reach_inference_and_defaults_are_preserved(self):
        ...
        imports = {'adapter': adapter, 'evaluate_linear_mocov3': evaluator}
        with tempfile.TemporaryDirectory() as tmp:
...
class TestArtifact(unittest.TestCase):
    def test_exact_native_identity_and_protocol(self):
        ...
        self.assertEqual(r['sha256'], '1100c2b2fce08c33d32034a1600876d1063a8f0e317704414675c989a6acedae')
        self.assertEqual(r['feature_options'], {'interpolation': 'bilinear', 'resize_short_side': 256})
