...
class TestArtifact(unittest.TestCase):
    def test_exact_checkpoint_and_protocol(self):
        ...
        self.assertEqual(r['sha256'], '03784482d8e9f8d7b89b3da2ba750227163aad9e605658046bf00a02cf431ba5')
        self.assertEqual(r['availability'], 'user_supplied')
        self.assertEqual(r['state_key'], 'target_encoder')
        self.assertEqual(r['strip_prefix'], '')
        self.assertEqual(r['feature_options'], {})
        self.assertEqual(r['checkpoint_epoch_stored'], 299)
        self.assertEqual(r['add_prefix'], 'target_encoder.')
