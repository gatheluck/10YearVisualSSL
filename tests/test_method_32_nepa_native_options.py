...
class TestArtifact(unittest.TestCase):
    def test_exact_checkpoint_and_protocol(self):
        ...
        self.assertEqual(r['sha256'], 'a7829af8790b6f400fe3f23f1b06e581a34e1521f3829c12ebddc2e0d63eb1d1')
        self.assertEqual(r['availability'], 'user_supplied')
        self.assertEqual(r['state_key'], 'ema_state_dict')
        self.assertEqual(r['strip_prefix'], '')
        self.assertEqual(r['feature_options'], {})
        self.assertEqual(r['checkpoint_epoch_stored'], 1599)
        self.assertEqual(r['add_prefix'], 'ema_model.')
