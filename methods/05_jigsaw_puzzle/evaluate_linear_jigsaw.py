"""Linear evaluation for Jigsaw: a probe on the frozen CFN encoder.

The representation is the model this port trains -- the shared CFN encoder
(`get_encoder()`), which maps an image to a 512-d feature. Images are resized to
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Jigsaw linear eval")
