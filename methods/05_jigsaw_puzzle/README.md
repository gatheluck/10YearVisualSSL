...
## Running
    ...
    python bin/resolve-config.py methods/05_jigsaw_puzzle/configs/step1.yaml \
    ...
    python bin/resolve-config.py methods/05_jigsaw_puzzle/configs/linear_eval.yaml \
