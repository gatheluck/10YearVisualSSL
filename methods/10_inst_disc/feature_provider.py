"""Feature-extraction provider for 10_inst_disc.
...
wrapper that reuses this method's own pieces, so the knowledge of how Instance
Discrimination turns an image into a vector stays in one place:
...
def extract_val_features(*, encoder_path: str, data_root: str, split: str,
    ...
    ev = importlib.import_module("evaluate_linear_instdisc")
