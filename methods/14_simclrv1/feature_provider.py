"""Feature-extraction provider for 14_simclrv1.
...
wrapper that reuses this method's own pieces, so the knowledge of how SimCLR
...
def extract_val_features(*, encoder_path: str, data_root: str, split: str,
    ...
    ev = importlib.import_module("evaluate_linear_simclr")
