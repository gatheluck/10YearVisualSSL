...
- **Not a full run:** `configs/step1.yaml` is the ViT-L/16 recipe (MAE pretrains
...
## Running
    ...
    python bin/resolve-config.py methods/25_mae/configs/step1.yaml \
    ...
    python bin/resolve-config.py methods/25_mae/configs/linear_eval.yaml \
