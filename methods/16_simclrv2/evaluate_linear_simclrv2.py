"""Linear evaluation for SimCLR v2: a probe on the frozen ResNet-50 backbone.
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="SimCLR v2 linear eval")
...
def run(args, config: "dict | None" = None, model=None) -> dict:
    ...
    print(f"SimCLR v2 linear eval  device={device}  img_size={train['img_size']}")
